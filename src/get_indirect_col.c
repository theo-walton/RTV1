...
/*   Updated: 2017/10/29 09:31:47 by twalton          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "rtv1.h"

static void	basic_surface_col(t_colour *result, t_intersect *intersect,
...
static void	get_random_ray_colour(t_colour *result, t_intersect *intersect,
				t_object *objects, t_light *lights)
{
	t_coor		vector;
	t_intersect	*new;
