...
/*   Updated: 2017/09/18 22:49:42 by twalton          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	fill_intersect(double consts[], t_intersect *intersect, t_coor *point, t_coor *vector)
{
	...
	if ((consts[0] == INFIN || consts[0] <= 0) && (consts[1] == INFIN || consts[1] <= 0))
		return (0);
	return (1);
}
...
int	get_cylinder_intersections(t_intersect *intersect, t_object *object, t_coor *point, t_coor *vector)
{
	...
	consts[3] = dot_product(vect3, vect3) - cylinder->radius * cylinder->radius * consts[0];
