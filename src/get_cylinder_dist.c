...
/*   Updated: 2017/10/09 18:01:03 by twalton          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static double	calc_c(t_coor *point_diff, t_coor *vector, t_cylinder *cylinder)
{
	t_coor temp;
	double dot;
...
double	get_cylinder_dist(t_coor *point, t_coor *vector, t_object *object)
{
	...
	coefficients[2] = calc_c(&point_diff, vector, cylinder);
	second_order_solver(result, coefficients[0], coefficients[1], coefficients[2]);
